...
export const getArtistByName = async (accessToken, artistName) => {
    try {
        ...
        const response = await axios.get(
            searchURL + '?q=' + artistName + '&type=artist', {
                headers: {
                    'Authorization': 'Bearer ' + accessToken,
                }
            }
...
export const getAudiobookByName = async (accessToken, audiobookName) => {
    try {
        ...
        const response = await axios.get(
            searchURL + '?q=' + audiobookName + '&type=audiobook', {
                headers: {
                    'Authorization': 'Bearer ' + accessToken,
                }
            }
...
export const getAudiobookByID = async (accessToken, audiobookID) => {
    try {
        const audiobookURL = 'https://api.spotify.com/v1/audiobooks/';

        const response = await axios.get(
            audiobookURL + audiobookID, {
                headers: {
                    'Authorization': 'Bearer ' + accessToken,
                }
            }
